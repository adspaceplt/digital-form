...
(async () => {
  ...
  for (const [tag, opts] of [['1280', { viewport: { width: 1280, height: 900 } }],
    ...
    await p.evaluate(() => {
      ...
      D.client_documents.push({ id: 'd1', client_id: 'c1', kind: 'offer', number: 'AQT/INT/2609001', issued_at: '2026-09-12', market: 'MY', subtotal: 21480, tax: 1718.4, total: 23198.4, bill_to: {}, lines: [], issued_by: 'adspacestudios@gmail.com', created_at: '2026-09-12T08:00:00Z', voided_at: null });
