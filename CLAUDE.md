...
| Documents (`js/documents.js`) | The Letter of Intent, numbered `AQT/INT/YYMMXXX` (sequence per month, file name swaps `/` for `-`), drawn in the browser with pdf-lib, stored as issued in `client_documents`, Void then Delete. |
