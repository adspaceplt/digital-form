...
- **2026-09-16** — Billing and Brand are already dedicated panes, so their forms are not hidden inside a second disclosure card. Imported clients may correct **Client since** from Key dates; **Active for** is derived from the recorded Active stage and is never a second duration field.
