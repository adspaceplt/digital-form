...
- **2026-09-16** — `js/state.js` is the only copy of how a list says it is loading, has nothing in it, or could not be read. A read that failed is never reported as an empty list.
