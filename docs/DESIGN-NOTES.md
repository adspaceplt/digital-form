# DESIGN.md as of 2026-09-26 (archive, with reasoning)

Not loaded automatically. The rules are in `DESIGN.md`; this is the long form,
with the reports, measurements and reasoning behind each. Search it before
changing a component (`grep -n "<component>" docs/DESIGN-NOTES.md`).
